...
/**
 * Контрактный генератор: на каждый эндпоинт — валидный запрос и полная сверка ответа со
 * спецификацией через [ContractValidator] (статус, content-type, JSON-схема тела, заголовки).
 * Тест падает, если найдено хотя бы одно расхождение док↔поведение.
 */
